...
class PlaybackEventMessage {
  ...
  final Id3MetadataMessage id3Metadata;
  ...
  static PlaybackEventMessage fromMap(Map<dynamic, dynamic> map) =>
      PlaybackEventMessage(
        ...
        id3Metadata: map['id3Metadata'] == null
            ? null
            : Id3MetadataMessage.fromMap(map['id3Metadata']),
...
class Id3MetadataMessage {
  ...
  static Id3MetadataMessage fromMap(Map<dynamic, dynamic> json) =>
      Id3MetadataMessage(
          title: json['title'],
          album: json['album'],
          artist: json['artist'],
